...
class GreetingsCog(commands.Cog, name="Greetings"):
    ...
    @commands.hybrid_command(  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
        name="welcome_test",
        description=app_commands.locale_str("Enviar una tarjeta de bienvenida de prueba en este canal (solo admin).", key="slash.descriptions.welcome_test"),
    )
    ...
    @commands.hybrid_command(  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
        name="goodbye_test",
        description=app_commands.locale_str("Enviar una tarjeta de despedida de prueba en este canal (solo admin).", key="slash.descriptions.goodbye_test"),
    )
    @app_commands.default_permissions(administrator=True)
    ...
    @commands.hybrid_group(fallback="config", description=app_commands.locale_str("Configurar ajustes de tarjetas de bienvenida.", key="slash.descriptions.welcome._"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.default_permissions(administrator=True)
    ...
    @welcome.command(name="channel", description=app_commands.locale_str("Definir el canal para mensajes de bienvenida.", key="slash.descriptions.welcome.channel"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.describe(channel=app_commands.locale_str("El canal para mensajes de bienvenida", key="slash.describes.welcome.channel.channel"))
    @app_commands.default_permissions(administrator=True)
    ...
    @welcome.command(name="toggle", description=app_commands.locale_str("Activar o desactivar mensajes de bienvenida.", key="slash.descriptions.welcome.toggle"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.default_permissions(administrator=True)
    ...
    @welcome.command(name="message", description=app_commands.locale_str("Definir la plantilla del mensaje de bienvenida.", key="slash.descriptions.welcome.message"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.describe(template=app_commands.locale_str("Plantilla de mensaje (marcadores: {user}, {server}, {mention})", key="slash.describes.welcome.message.template"))
    @app_commands.default_permissions(administrator=True)
    ...
    @commands.hybrid_group(fallback="config", description=app_commands.locale_str("Configurar ajustes de tarjetas de despedida.", key="slash.descriptions.goodbye._"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.default_permissions(administrator=True)
    ...
    @goodbye.command(name="channel", description=app_commands.locale_str("Definir el canal para mensajes de despedida.", key="slash.descriptions.goodbye.channel"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.describe(channel=app_commands.locale_str("El canal para mensajes de despedida", key="slash.describes.goodbye.channel.channel"))
    @app_commands.default_permissions(administrator=True)
    ...
    @goodbye.command(name="toggle", description=app_commands.locale_str("Activar o desactivar mensajes de despedida.", key="slash.descriptions.goodbye.toggle"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.default_permissions(administrator=True)
    ...
    @goodbye.command(name="message", description=app_commands.locale_str("Definir la plantilla del mensaje de despedida.", key="slash.descriptions.goodbye.message"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    @app_commands.describe(template=app_commands.locale_str("Plantilla de mensaje (marcadores: {user}, {server}, {mention})", key="slash.describes.goodbye.message.template"))
    @app_commands.default_permissions(administrator=True)
