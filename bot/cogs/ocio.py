...
class OcioCog(commands.Cog, name="Ocio"):
    ...
    @commands.hybrid_command(name="dados", description=app_commands.locale_str("Tirar un dado.", key="slash.descriptions.dados"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
    ...
    @commands.hybrid_command(name="banana", description=app_commands.locale_str("Medir algo en bananas.", key="slash.descriptions.banana"))  # type: ignore[arg-type]  # discord.py hybrid_command stub limitation
