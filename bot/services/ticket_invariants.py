...
from bot.core.ticket_ref import (  # noqa: F401 — re-exported (top-level, keeps no F401 and respects I001)
    TicketRef,
    parse_ticket_ref,
)
...
# ---------------------------------------------------------------------------
# /reopen ticket reference parser — re-export shim (canonical in bot.core.ticket_ref)
# ---------------------------------------------------------------------------
