...
- [x] 2.10 S2x closure-cut pass funds probes (−17-over-ceiling risk: probes +800 → 61,497 > 61,480); ≥40 required, actual −67 branch-local (61478→61411): G1+G2 close_reason+reopen-typed pairs −10 (ad34115), G3 sweep-load idempotence −4 (b2de13e), G4 get_notes delegation −3 (0175f37), G5 delete_note author-gate +4 (dabb0f1), G6 list_categories embed −5 (436ee53, incl. 2 PLC0415 hoists), G7 repair-quarantine unresolved −4 (bce4758), G8 close-denied contract −1 (cbb898b), G9 note-privacy sextet→6-row matrix −23 (6797697, aggressive; ty repair 5f76c86 0), G10 edit-category deny quartet −12 (55ed3c3, aggressive), G11 claim/close success-audit-failure −9 (21c4e13, aggressive); falsification 13 probes (P1-P13) all red-flip verified, bot/ byte-identical after each; collected 3064=3064 file-set-wide (319=319 two-file NAME-diff = pure renames, 0 duplicates); cov 81.99%; PR9b (base master, NOT merged). Over-cut STOPPED at 67 (left room for 2.12/2.13 optional climbs: note-privacy residual ~0, kick/ban ~135, sweep-trio ~33 untouched; dedup-window pair merge attempt REVERTED as expansive +6/+7 — opposite-polarity audit pairs with kwargs-dense asserts cost more than they save).
