...
- [x] S2.1 Acquire attempt ledger — `--request-id req-c5q-s2 --work-unit "S2 slash-policy" --evidence-goal "prefix inert [], no DM branch, help slash-only, AGENTS+specs"` (files: none) — est 0 ln
