...
- [ ] S5b.8 Settle attempt — full suite + jscpd + uv-lock + `vulture bot/ tests/` advisory-clean → capture → sha256 → settle (files: none) — est 0 ln — verify: `vulture bot/ tests/` clean *(batch-1 battery green: 2750p/18s cov 84.83%, ruff+ty fatal, lock ok, jscpd under ceilings; evidence sha256:bb75d595…; settle below)*
