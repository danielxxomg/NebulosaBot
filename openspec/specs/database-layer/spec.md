...
<!-- BEGIN DELTA: production-live-close S5 -->
...
<!-- END DELTA: production-live-close S5 -->

<!-- BEGIN DELTA: welcome-neon-timer-banana (database-layer) -->
## ADDED Requirements
...
<!-- END DELTA: welcome-neon-timer-banana (database-layer) -->
