...
<!-- BEGIN DELTA: greeting-templates (greeting-config) -->
...
<!-- END DELTA: greeting-templates (greeting-config) -->
...
<!-- BEGIN DELTA: welcome-neon-timer-banana (greeting-config) -->
...
<!-- END DELTA: welcome-neon-timer-banana (greeting-config) -->

<!-- BEGIN DELTA: ops-zero-lite (greeting-config) -->
## ADDED Requirements
...
<!-- END DELTA: ops-zero-lite (greeting-config) -->
