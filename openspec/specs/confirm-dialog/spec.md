...
The system MUST provide a `ConfirmCancelView` that sends an ephemeral embed with Confirm and Cancel buttons. The view MUST time out after 30 seconds, disabling both buttons on timeout.
