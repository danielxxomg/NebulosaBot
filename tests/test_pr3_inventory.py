...
class TestGuildScopeInventory:
    """Guild-scope gap inventory — ID-only DB method detection contract."""
...
class TestReadOnlyInventoryContract:
    """Read-only inventory contract — CDC/TTL docs, FK retention, no-DDL guarantee."""

    def test_schema_inventory_cdc_and_ttl_documented(self) -> None:
        """Inventory MUST document CDC 6 tables and TTL 300s/30s."""
